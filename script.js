...
function launchGame(gameName) {
    ...
    // 设置游戏路径
    // 注意：这里假设你会在 games 文件夹下建 snake 文件夹
...
/**
 * 这个函数的作用是获取当前浏览器窗口的实际可见高度，
 * 然后直接把它应用到 <body> 元素上，确保整个应用的根容器高度正确。
 */
function setAppHeight() {
    // 直接设置 <body> 的高度，让它精确匹配可见区域
